...
export function WhatsAppFab() {
  ...
  const href = whatsappUrl(config, `Hola! Vengo de la web de ${config.name}. Quería hacerte una consulta.`);
  ...
  // Sin número de WhatsApp cargado en /admin/ajustes no hay botón que mostrar.
